    ...
    <div class="max-w-6xl w-full">
        <div class="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div class="hidden lg:flex flex-col justify-center space-y-8 p-8">
                <!-- Logo -->
                <div class="flex items-center justify-center p-8 bg-white/60 backdrop-blur-md rounded-3xl shadow-xl">
            ...
            <div class="w-full">
                <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/20 hover:shadow-3xl transition-all duration-500">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <div class="relative group">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-indigo-600 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input id="email" 
                                       ...
                                       autocomplete="email" 
                                       autofocus
                                       class="block w-full pl-12 pr-4 py-3.5 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <label for="remember" class="ml-2 block text-sm text-gray-700 cursor-pointer hover:text-indigo-600 transition-colors duration-200">
                                    {{ __('Remember Me') }}
                                </label>
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <button type="button" 
                                        disabled
                                        class="flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-300 rounded-xl 

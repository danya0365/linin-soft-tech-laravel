                    ...
                    @forelse($inventories as $index => $inventory)
                        <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent dark:hover:from-gray-700/50 dark:hover:to-transparent transition-all duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Inventory Group Id:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $inventory->inventory_group_id ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Name:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $inventory->name ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Unit:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $inventory->unit ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Total Quantity:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $inventory->total_quantity ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Remain Quantity:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $inventory->remain_quantity ?? '-' }}</span>
                                        </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">

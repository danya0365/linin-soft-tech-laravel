                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                        <div class="mb-2">
                                            ...
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $income->type_name ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Table Name:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $income->table_name ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Table Id:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $income->table_id ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            <span class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Amount:</span>
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $income->amount ?? '-' }}</span>
                                        </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <x-crud.action-buttons :model="$income" resource="incomes" />
                            </td>
                        </tr>
                    @empty
                        <tr>

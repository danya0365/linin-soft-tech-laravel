                    ...
                    @forelse($expenses as $index => $expense)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-gray-900 dark:text-gray-100">
                                <strong>Type Name:</strong> {{ $expense->type_name ?? '-' }}<br><strong>Table Name:</strong> {{ $expense->table_name ?? '-' }}<br><strong>Table Id:</strong> {{ $expense->table_id ?? '-' }}<br><strong>Amount:</strong> {{ $expense->amount ?? '-' }}
                            </td>
                            <td class="px-6 py-4">

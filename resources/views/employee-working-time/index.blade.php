                    ...
                    @forelse($employeeWorkingTimes as $index => $employeeWorkingTime)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-gray-900 dark:text-gray-100">
                                <strong>Employee Id:</strong> {{ $employeeWorkingTime->employee_id ?? '-' }}<br><strong>Working Date:</strong> {{ $employeeWorkingTime->working_date ?? '-' }}<br><strong>Time Duration:</strong> {{ $employeeWorkingTime->time_duration ?? '-' }}
                            </td>
                            <td class="px-6 py-4">

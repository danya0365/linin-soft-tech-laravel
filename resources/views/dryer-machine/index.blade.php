...
<div class="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div class="overflow-x-auto rounded-lg shadow">
            <table class="w-full text-sm text-left border-collapse bg-white dark:bg-gray-800">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($dryerMachines as $index => $dryerMachine)
                        <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent dark:hover:from-gray-700/50 dark:hover:to-transparent transition-all duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="space-y-1">
                                        <div class="mb-2">
                                            ...
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $dryerMachine->name ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                                            ...
                                            <div class="mt-1">
                                                @if($dryerMachine->photo)
                                                    <img src="{{ asset($dryerMachine->photo) }}" alt="{{ $dryerMachine->name }}" class="h-16 w-16 object-cover rounded-md border border-gray-200 dark:border-gray-700">
                                                @else
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <span class="ml-2 text-sm text-gray-900 dark:text-gray-100">{{ $dryerMachine->maximum_weight ?? '-' }}</span>
                                        </div>
                                        <div class="mb-2">
                            ...
                            <td class="px-6 py-4">
                                <x-crud.action-buttons :model="$dryerMachine" resource="dryer-machines" />
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p>No Dryer Machine available</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
    ...
    <div class="mt-6">{{ $dryerMachines->links() }}</div>
</div>
@endsection
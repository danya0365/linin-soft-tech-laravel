...
@section('template_title')
    Show Customer Operation Daily Summary
@endsection
@section('content')
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <x-crud.breadcrumb :items="[['label' => 'Admin', 'route' => 'admin'],['label' => 'Customer Operation Daily Summary', 'route' => 'customer-operation-daily-summaries.index'],['label' => 'Details']]" />
    <x-ui.card>
        <x-slot:header>
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Customer Operation Daily Summary Details</h2>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div><p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Billing Weight</p><p class="font-semibold text-gray-900 dark:text-white">{{ $customerOperationDailySummary->total_billing_weight ?? '-' }}</p></div>
        </div>
    </x-ui.card>
</div>
@endsection
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 space-y-3">
                    ...
                    <div class="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-2">
                        ...
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $operation['total_iron_piece'] ? number_format($operation['total_iron_piece']) : '0' }} ชิ้น</span>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-start p-3 bg-white dark:bg-gray-700 rounded-md border border-gray-100 dark:border-gray-600 shadow-sm">
                            ...
                            <div class="text-right ml-4">
                                ...
                                <span class="inline-flex items-center text-xs text-gray-500 dark:text-gray-400 mt-1 gap-1">
                                    <span class="w-2 h-2 rounded-full border border-gray-200 dark:border-gray-600" style="background-color: {{ $operationLinenProduct['color'] }}"></span>

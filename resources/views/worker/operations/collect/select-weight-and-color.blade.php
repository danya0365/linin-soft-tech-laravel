                        ...
                        <div class="box box-info padding-1">
                            ...
                            <div class="box-footer">
                                <div class="row g-2 mt-2">
                                    ...
                                    <div class="col-6">
                                        <div class="d-grid gap-2" style="min-height: 60px">
                                            <button class="btn btn-danger" type="button" onclick="{{ route('worker.operation.collect.delete-operation-linen-product', ['operationId' => $operation['id'], 'operationLinenProductId' => $operationLinenProduct['id']]) }}">ลบ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
>
    <div class="space-y-6">
        ...
        <x-worker.card :title="$linenType['name']">
            ...
            {{-- Manual submit buttons (hidden by default as per original logic, but kept for structure) --}}
            <div class="hidden mt-4">
                 <button class="submit px-4 py-2 bg-amber-500 text-white rounded-lg">ยืนยัน</button>
            </div>
        </x-worker.card>
        @endforeach
    </div>

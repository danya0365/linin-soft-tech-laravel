        ...
        <x-worker.card>
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div class="space-y-2 flex-1">
                    ...
                    <div class="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400">
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ $operationLinenProduct['packing_piece'] ? $operationLinenProduct['packing_piece'] : '0' }} ชิ้น</span>
                        </div>
                        <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto">
                    <a href="{{ route('worker.operation.packing.select-linen-case', ['operationId' => $operation['id'], 'operationLinenProductId' => $operationLinenProduct['id']]) }}" 
                    ...
                    <a href="{{ route('worker.operation.packing.delete-operation-linen-product', ['operationId' => $operation['id'], 'operationLinenProductId' => $operationLinenProduct['id']]) }}" 

...
<x-worker.page 
    title="เลือกลูกค้า" 
    subtitle="Select Customer for Wash" 
    ...
    <div class="space-y-6">
        ...
        <x-worker.card :title="$customerGroup['name']">
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
                ...
                <a href="{{ route('worker.operation.wash.set-select-customer', ['operationId' => $operation['id'], 'customerId' => $customer['id']]) }}" 
                   ...
                   style="min-height: 150px">
                    ...
                    <div class="mb-3 transform group-hover:scale-110 transition-transform duration-200">
                        <div class="w-16 h-16 flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 rounded-full text-blue-600 dark:text-blue-400 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/30 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">
                            <i class="bi bi-building text-3xl"></i>
                        </div>
                    </div>
                    
                    <div class="text-center px-2">
                        <h4 class="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors line-clamp-2">
                            {{ $customer['name'] }}
                        </h4>
                    </div>
                </a>

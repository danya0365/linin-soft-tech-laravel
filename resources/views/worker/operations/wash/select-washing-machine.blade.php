...
@section('content')
<x-worker.page 
    title="เลือกเครื่องซักผ้า" 
    subtitle="Select Washing Machine" 
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-2 text-sm text-red-700 dark:text-red-300">
                    <a href="{{ route('worker.operation.wash.employee-summary', ['operationId' => session('operation_id')]) }}" class="underline hover:text-red-900 dark:hover:text-red-100">
                        {{ session('error') }}
                    </a>
                </div>
            </div>

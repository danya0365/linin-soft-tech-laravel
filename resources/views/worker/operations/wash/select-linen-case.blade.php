            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('worker.operation.wash.set-select-linen-case', ['operationId' => $operation['id'], 'linenCase' => $operationLinenCase['var'], 'operationLinenProductId' => $operationLinenProduct->id]) }}">

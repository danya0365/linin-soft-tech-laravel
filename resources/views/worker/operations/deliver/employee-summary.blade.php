    ...
    $(function(){
        ...
        function closeOperation(){
            removeOnUnload(function(){
                window.location='{{ route('worker.operation.deliver.set-close', ['operationId' => $operation['id']]) }}'
            })
        }

        function reopenOperation(){
            removeOnUnload(function(){
                window.location='{{ route('worker.operation.deliver.set-in-progress', ['operationId' => $operation['id']]) }}'
            })
        }

        function selectCollectOperation(){
            removeOnUnload(function(){
                window.location='{{ route('worker.operation.deliver.select-collect-operation', ['operationId' => $operation['id']]) }}'
            })
        }

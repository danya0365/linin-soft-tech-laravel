                    ...
                    @forelse($departmentDailyCostLogs as $index => $departmentDailyCostLog)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 text-gray-900 dark:text-gray-100">
                                <strong>Department Id:</strong> {{ $departmentDailyCostLog->department_id ?? '-' }}<br><strong>Daily Date:</strong> {{ $departmentDailyCostLog->daily_date ?? '-' }}<br><strong>Cost:</strong> {{ $departmentDailyCostLog->cost ?? '-' }}
                            </td>
                            <td class="px-6 py-4">

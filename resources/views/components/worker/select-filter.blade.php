...
<div class="flex items-center gap-0 w-full">
    ...
    <select 
        id="{{ $name }}" 
        name="{{ $name }}" 
        class="px-3 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-r-lg text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-amber-500 w-full min-w-0"

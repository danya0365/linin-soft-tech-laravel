...
<div class="mb-4">
    ...
    @if(isset($washingMachine->photo) && $washingMachine->photo)
        <div class="mb-3">
            <img src="{{ asset($washingMachine->photo) }}" alt="Current Photo" class="h-32 w-auto object-cover rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">

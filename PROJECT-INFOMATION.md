...
***รวมราคาเหมา 226,000 บาท ตีกลมๆ 220,000 บาท***
...
***รวมราคาเหมา 121,000 บาท ตีกลมๆ 120,000 บาท***
...
```{ fields: { id, employee_id, operation_type = enum('wash', 'dry', 'iron', 'packing', 'collect') action_type = enum(start, stop) } }```
	 ...
	 4. เลือกกองผ้าจากลูกค้าที่รับมาช่วงเช้า เช่น กองผ้า Customer A ขนาด 100kg. (เลือก Job Group)
	 5. ชนิดผ้า (ผ้าขน)
	 6. ผ้าเช็ดมือ

...
class CollectController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.collect.select-job-group'));
    }
    ...
    public function selectJobGroup()
    {
        ...
        return view('worker.operations-v1.collect.select-job-group', ['customers' => $customers]);
    }
    ...
    public function setSelectJobGroup($jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.collect.select-employee', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function selectEmployee($jobGroupId)
    {
        ...
        return view('worker.operations-v1.collect.select-employee', ['departments' => $departments->toArray(), 'jobGroup' => $jobGroup->toArray()]);
    }
    ...
    public function setSelectEmployee($jobGroupId, $employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.collect.submit', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function getSubmit(Request $request, $jobGroupId)
    {
        $jobGroup = JobGroup::with('employee')
            ...
            ->with('collectEmployee')
            ->where('id', $jobGroupId)->first();
        return view('worker.operations-v1.collect.submit', ['jobGroup' => $jobGroup->toArray()]);
    }
    ...
    public function postSubmit(Request $request, $jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.collect.employee-result', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function getEmployeeResult(Request $request, $jobGroupId)
    {
        ...
        return view('worker.operations-v1.collect.employee-result', ['jobGroup' => $jobGroup->toArray(), 'summaryReports' => $summaryReports, 'workingDuration' => $workingDuration]);
    }
    ...
    public function postEmployeeResult(Request $request, $jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.collect.employee-result', ['jobGroupId' => $jobGroupId]));
    }
}

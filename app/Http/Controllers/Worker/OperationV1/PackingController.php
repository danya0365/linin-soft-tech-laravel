...
class PackingController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.packing.select-job-group'));
    }
    ...
    public function selectJobGroup()
    {
        ...
        return view('worker.operations-v1.packing.select-job-group', ['customers' => $customers]);
    }
    ...
    public function setSelectJobGroup($jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.packing.select-employee', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function selectEmployee($jobGroupId)
    {
        ...
        return view('worker.operations-v1.packing.select-employee', ['departments' => $departments->toArray(), 'jobGroup' => $jobGroup->toArray()]);
    }
    ...
    public function setSelectEmployee($jobGroupId, $employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.packing.submit', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function getSubmit(Request $request, $jobGroupId)
    {
        $jobGroup = JobGroup::with('employee')
            ...
            ->with('collectEmployee')
            ->where('id', $jobGroupId)->first();
        return view('worker.operations-v1.packing.submit', ['jobGroup' => $jobGroup->toArray()]);
    }
    ...
    public function postSubmit(Request $request, $jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.packing.employee-result', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function getEmployeeResult($jobGroupId)
    {
        ...
        return view('worker.operations-v1.packing.employee-result', ['jobGroup' => $jobGroup->toArray(), 'summaryReports' => $summaryReports, 'workingDuration' => $workingDuration]);
    }
}

...
class DryController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.dry.select-job'));
    }
    ...
    public function selectJob()
    {
        ...
        return view('worker.operations-v1.dry.select-job', ['customers' => $customers]);
    }
    ...
    public function setSelectJob($jobId)
    {
        ...
        return redirect(route('worker.operation-v1.dry.select-employee', ['jobId' => $job->id]));
    }
    ...
    public function selectEmployee($jobId)
    {
        ...
        return view('worker.operations-v1.dry.select-employee', ['departments' => $departments->toArray(), 'job' => $job->toArray()]);
    }
    ...
    public function setSelectEmployee($jobId, $employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.dry.select-dryer-machine', ['jobId' => $job->id]));
    }
    ...
    public function selectDryerMachine($jobId)
    {
        ...
        return view('worker.operations-v1.dry.select-dryer-machine', ['job' => $job->toArray(), 'dryerMachines' => $dryerMachines->toArray()]);
    }
    ...
    public function setSelectDryerMachine($jobId, $dryerMachineId)
    {
        ...
        return redirect(route('worker.operation-v1.dry.submit', ['jobId' => $job->id]));
    }
    ...
    public function getSubmit(Request $request, $jobId)
    {
        ...
        return view('worker.operations-v1.dry.submit', ['job' => $job->toArray()]);
    }
    ...
    public function postSubmit(Request $request, $jobId)
    {
        ...
        return redirect(route('worker.operation-v1.dry.employee-result', ['jobId' => $job->id]));
    }
    ...
    public function getEmployeeResult($jobId)
    {
        ...
        return view('worker.operations-v1.dry.employee-result', ['job' => $job->toArray(), 'summaryReports' => $summaryReports, 'workingDuration' => $workingDuration]);
    }
}

...
class PickUpController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.pickup.select-employee'));
    }

    public function selectEmployee()
    {
        $departments = Department::with('employees')->where('id', DepartmentNameId::PickUp())->get();
        return view('worker.operations-v1.pickups.select-employee', ['departments' => $departments->toArray()]);
    }
    ...
    public function setSelectEmployee($employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.pickup.select-customer', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function selectCustomer($jobGroupId)
    {
        ...
        return view('worker.operations-v1.pickups.select-customer', ['customerGroups' => $customerGroup->toArray(), 'jobGroup' => $jobGroup->toArray()]);
    }
    ...
    public function setSelectCustomer($jobGroupId, $customerId)
    {
        ...
        return redirect(route('worker.operation-v1.pickup.submit', ['jobGroupId' => $jobGroup->id]));
    }
    ...
    public function getSubmit(Request $request, $jobGroupId)
    {
        ...
        return view('worker.operations-v1.pickups.submit', ['jobGroup' => $jobGroup]);
    }

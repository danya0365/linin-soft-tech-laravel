...
class IronController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.iron.select-job'));
    }
    ...
    public function selectJob()
    {
        ...
        return view('worker.operations-v1.iron.select-job', ['customers' => $customers]);
    }
    ...
    public function setSelectJob($jobId)
    {
        ...
        return redirect(route('worker.operation-v1.iron.select-employee', ['jobId' => $job->id]));
    }
    ...
    public function selectEmployee($jobId)
    {
        ...
        return view('worker.operations-v1.iron.select-employee', ['departments' => $departments->toArray(), 'job' => $job->toArray()]);
    }
    ...
    public function setSelectEmployee($jobId, $employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.iron.submit', ['jobId' => $job->id]));
    }
    ...
    public function getSubmit(Request $request, $jobId)
    {
        $job = Job::with('employee')
            ...
            ->with('ironEmployee')
            ->where('id', $jobId)->first();
        return view('worker.operations-v1.iron.submit', ['job' => $job->toArray()]);
    }
    ...
    public function postSubmit(Request $request, $jobId)
    {
        ...
        return redirect(route('worker.operation-v1.iron.employee-result', ['jobId' => $job->id]));
    }
    ...
    public function getEmployeeResult($jobId)
    {
        ...
        return view('worker.operations-v1.iron.employee-result', ['job' => $job->toArray(), 'summaryReports' => $summaryReports, 'workingDuration' => $workingDuration]);
    }
    ...
    public function postEmployeeResult(Request $request, $jobId)
    {
        ...
        return redirect(route('worker.operation-v1.iron.employee-result', ['jobId' => $jobId]));
    }
}

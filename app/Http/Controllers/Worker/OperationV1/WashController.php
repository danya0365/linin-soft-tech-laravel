...
namespace App\Http\Controllers\Worker\OperationV1;
...
class WashController extends Controller
{
    ...
    {
        return redirect(route('worker.operation-v1.wash.select-employee'));
    }

    public function selectEmployee()
    {
        $departments = Department::with('employees')->where('id', DepartmentNameId::Wash())->get();
        return view('worker.operations-v1.wash.select-employee', ['departments' => $departments->toArray()]);
    }
    ...
    public function setSelectEmployee($employeeId)
    {
        ...
        return redirect(route('worker.operation-v1.wash.select-customer', ['jobId' => $job->id]));
    }
    ...
    public function selectCustomer($jobId)
    {
        ...
        return view('worker.operations-v1.wash.select-customer', ['customerGroups' => $customerGroup->toArray(), 'job' => $job->toArray()]);
    }
    ...
    public function setSelectCustomer($jobId, $customerId)
    {
        ...
        $job->save();
        return redirect(route('worker.operation-v1.wash.select-job-group', ['jobId' => $job->id]));
    }
    ...
    public function selectJobGroup($jobId)
    {
        ...
        return view('worker.operations-v1.wash.select-job-group', ['todayJobGroups' => $todayJobGroups->toArray(), 'job' => $job->toArray()]);
    }
    ...
    public function setSelectJobGroup($jobId, $jobGroupId)
    {
        ...
        return redirect(route('worker.operation-v1.wash.select-job-case', ['jobId' => $job->id]));
    }
    ...
    public function selectJobCase($jobId)
    {
        ...
        return view('worker.operations-v1.wash.select-job-case', ['job' => $job->toArray(), 'jobCases' => $jobCases]);
    }
    ...
    public function setSelectJobCase($jobId, $jobCase)
    {
        ...
        $job->save();
        return redirect(route('worker.operation-v1.wash.select-washing-machine', ['jobId' => $job->id]));
    }
    ...
    public function selectWashingMachine($jobId)
    {
        ...
        return view('worker.operations-v1.wash.select-washing-machine', ['job' => $job->toArray(), 'washingMachines' => $washingMachines->toArray()]);
    }
    ...
    public function setSelectWashingMachine($jobId, $washingMachineId)
    {
        ...
        return redirect(route('worker.operation-v1.wash.select-linen-type', ['jobId' => $job->id]));
    }
    ...
    public function selectLinenType($jobId)
    {
        ...
        return view('worker.operations-v1.wash.select-linen-type', ['job' => $job->toArray(), 'linenTypes' => $linenTypes->toArray(), 'linenProductJson' => $linenProducts->toJson()]);
    }
    ...
    public function setSelectLinenType($jobId, $tags)
    {
        ...
        return redirect(route('worker.operation-v1.wash.submit', ['jobId' => $job->id]));
    }
    ...
    public function getSubmit(Request $request, $jobId)
    {
        ...
        return view('worker.operations-v1.wash.submit', ['job' => $job->toArray()]);
    }
    ...
    public function postSubmit(Request $request, $jobId)
    {
        ...
        return redirect(route('worker.operation-v1.wash.employee-result', ['jobId' => $job->id]));
    }
    ...
    public function getEmployeeResult($jobId)
    {
        ...
        return view('worker.operations-v1.wash.employee-result', ['job' => $job->toArray(), 'summaryReports' => $summaryReports, 'workingDuration' => $workingDuration]);
    }
}
